...
if [ "$versao" == "XM" ]; then
	...
	URL='http://dl.ubnt.com/firmwares/XN-fw/v6.0.3/XM.v6.0.3.30600.170329.1831.bin'
fi
if [ "$versao" == "XW" ]; then
        #URL='http://dl.ubnt.com/firmwares/XW-fw/v5.6.6/XW.v5.6.6.29183.160526.1205.bin'
	URL='http://dl.ubnt.com/firmwares/XW-fw/v6.0.3/XW.v6.0.3.30600.170329.1817.bin'
fi
if [ "$versao" == "TI" ]; then
